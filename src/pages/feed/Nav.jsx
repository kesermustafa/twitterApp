            ...
            {!user ? (<div className='size-12 bg-zinc-400 rounded-full animate-bounce'/>) :
                <div className={'flex flex-col md:me-5 max-md:w-full gap-5'}>
                    <div className='flex flex-col items-center gap-3'>
                        <img className={'rounded-full w-10 h-10'} src={user?.photoURL} alt="user-img"/>
                    ...
                    <button
                        ...
                        className=' mx-auto flex flex-col px-3 gap-1 justify-center items-center text-2xl md:text-base p-1 bg-zinc-700 rounded transition hover:bg-zinc-900 cursor-pointer'>
